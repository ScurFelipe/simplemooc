...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='user',
            name='username',
            field=models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'Nome de usuário só pode conter letra, numeros ou os seguintes caracteres @ / . / + / - / _  ', 'invalid')], verbose_name='Nome de Usuário'),
        ),
