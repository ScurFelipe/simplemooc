...
def enrollment(request, slug):
    ...
    if created:
        ...
        messages.info(request, 'Você ja está inscrito nesse curso.')
...
@login_required
@enrollment_required
def single_lesson(request, slug, pk):
    ...
    template_name = 'courses/single_lesson.html'
    context = {
        'course': course,
        'single_lesson': lesson,
    }
    return render(request, template_name, context)
...
def material(request, slug, pk):
    ...
    if not request.user.is_staff and not lesson.is_available():
        ...
        return redirect('courses:single_lesson', slug=course.slug, pk=single_lesson.pk)
